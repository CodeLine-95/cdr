  ...
  getGoodsDetail() {
    ...
    let resData = {
      "detail": {
        ...
        "content": "<p>测试商品<\/p><p><img src=\"http:\/\/shop.qsjob.top\/uploads\/20210208215957afaaf7919.png\" _src=\"http:\/\/shop.qsjob.top\/uploads\/20210208215957afaaf7919.png\"\/><\/p>",
        "goods_sort": 100,
        "delivery_id": 10001,
        "goods_status": {
          "text": "上架",
        ...
        "category": {
          ...
          "image_id": 0,
          "sort": 100,
          "create_time": "2021-02-08 21:58:21"
        },
        "image": [{
          "id": 10001,
          "goods_id": 10001,
          "image_id": 10002,
          "file_path": "https:\/\/shop.qsjob.top\/uploads\/20210208215957afaaf7919.png",
          "file_name": "20210208215957afaaf7919.png",
          "file_url": ""
        }],
        "spec": [{
          "goods_spec_id": 10001,
    ...
    let data = _this.initGoodsDetailData(resData);
    ...
    // }, function(result) {
    //   // 初始化商品详情数据
    //   let data = _this.initGoodsDetailData(data);
    //   _this.setData(data);
    // });
  },
